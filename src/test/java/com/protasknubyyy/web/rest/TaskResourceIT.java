...
import static com.protasknubyyy.domain.TaskAsserts.*;
...
class TaskResourceIT {
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).status(UPDATED_STATUS).dueDate(UPDATED_DUE_DATE);
