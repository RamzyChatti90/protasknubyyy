...
import static com.protasknubyyy.domain.ProjectAsserts.*;
import static com.protasknubyyy.web.rest.TestUtil.createUpdateProxyForBean;
...
import com.protasknubyyy.IntegrationTest;
...
class ProjectResourceIT {
    ...
    public static Project createEntity() {
        return new Project().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).startDate(DEFAULT_START_DATE).dueDate(DEFAULT_DUE_DATE);
    }
    ...
    public static Project createUpdatedEntity() {
        return new Project().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).startDate(UPDATED_START_DATE).dueDate(UPDATED_DUE_DATE);
    }
    ...
    void putExistingProject() throws Exception {
        ...
        updatedProject.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).startDate(UPDATED_START_DATE).dueDate(UPDATED_DUE_DATE);
    ...
    void partialUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).startDate(UPDATED_START_DATE).dueDate(UPDATED_DUE_DATE);
